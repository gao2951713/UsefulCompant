...
public interface BizCommentDao extends BaseDao<BizComment>{
	 ...
	 * @return count 评论条数
	 */
	public List<Object[]> findCommentCount(Integer menu_id,String range_code,Integer api_id,String chart_type,Integer question_id);
	/**
	 * 取得该图例对应的评论详细信息
	 * @param menu_id 菜单编号
	 * @param range_code 区域编号
